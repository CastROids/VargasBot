...
public class Administrador extends Perfil {
    ...
    public void generarReporteVendedor(Vendedor vendedor) throws InputMismatchException{
        ...
        for(int i=0; i<vendedor.getListaVentas().size(); i++){
            System.out.println(vendedor.getListaVentas().get(i).getIdVenta()+"\t|"+vendedor.getListaVentas().get(i).getFecha());
            for(int j=0; j<vendedor.getListaVentas().get(i).getListaProductos().size(); j++){
                System.out.println("Producto: "+vendedor.getListaVentas().get(i).getListaProductos().get(j).getNombre()+"\tx"+vendedor.getListaVentas().get(i).getListaCantidades().get(j)+"\n");
            }
    ...
    public void gestionarInventario(Inventario inventario) throws InputMismatchException{
        ...
        for(int i=0; i<inventario.getListaProductos().size(); i++){
            ...
            System.out.println(inventario.getListaProductos().get(i).getIdProducto()+"\t|"+inventario.getListaProductos().get(i).getNombre()+"\t|"+inventario.getListaProductos().get(i).getCategoria()+"\t|"+inventario.getListaProductos().get(i).getStock()+"\t| $"+inventario.getListaProductos().get(i).getPrecio());
        }
                ...
                do{
                    ...
                    do{
                        try {
                            ...
                            System.out.println("Debe ingresar una cantidad válida: un valor numérico entero mayor que 0\n");
                        }
                        if (nuevaCantidad<0) {
